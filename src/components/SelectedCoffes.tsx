...
import { clientAdressData } from './Cheout'
    ...
    <div>
      ...
      <div className="bg-base-200 mt-4 p-10 rounded-tl-[6px] rounded-tr-[44px] rounded-br-[6px] rounded-bl-[44px]">
        ...
        <div className="flex flex-col gap-3">
          ...
          {cartItens.length == 0 ? (
            <button
              className="w-[368px] h-[46px] bg-yellow-300 text-white uppercase rounded-md mt-6 font-bold text-sm transition-colors duration-200 disabled:cursor-not-allowed disabled:bg-opacity-60"
              type="submit"
              disabled
            >
              Confirmar pedido
            ...
            <button
              className="w-[368px] h-[46px] bg-yellow-300 text-white uppercase rounded-md mt-6 font-bold text-sm transition-colors duration-200 hover:bg-yellow-500"
              type="submit"
            >
              Confirmar pedido
            </button>
